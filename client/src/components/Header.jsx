 ...
 const navigate=useNavigate();
    ...
    text-center my-20'
        ...
        bg-white px-6 py-1 rounded-full border border-neutral-500'
            ...
            <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:mas-w-[590px] mx-auto
        mt-10 text-center'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div
                ...
                {Array(6).fill('').map((item, index) => (
                    <motion.img
                        ...
                        className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10 ' src={index % 2 == 0 ? assets.sample_img_2 : assets.sample_img_1} key={index} alt="" width={70} />
                ))}
            </motion.div>
